...
function IconPaths({
  ...
  switch (name) {
    ...
    case "thumbs-down":
      return (
        <>
          <path d="M17 14V4a2 2 0 0 0-2-2H5.34a2 2 0 0 0-1.95 1.57l-1.3 6A2 2 0 0 0 4 12h6v2a2 2 0 0 0 2 2h1a1 1 0 0 0 1-1v-1z" />
          <path d="M21 14V4a1 1 0 0 0-1-1h-1a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1z" />
        </>
      );
    default:
      return null;
